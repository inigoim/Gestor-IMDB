	...
	public static void main(String[] args){
		...
		while(opcion!=0) {
			...
			switch(opcion) {
				...
				case 1:
					System.out.println("Introduce el nombre de la pelicula sobre la que quieres ver la información: ");
					String tituloPelicula = sc.nextLine();
					catalogo.imprimirInfoPelicula(tituloPelicula);
					break;

				case 2:
					System.out.println("Introduce el nombre de el interprete sobre el que quieres ver la información: ");
					String nombreInterprete = sc.nextLine();
					catalogo.imprimirInfoPelicula(nombreInterprete);
					break;

				case 3:
					System.out.println("Introduce el nombre que deseas puntuar: ");
